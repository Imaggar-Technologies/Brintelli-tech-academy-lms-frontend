  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: "Schedule Meet",
        icon: Calendar,
        path: "/student/mentor-connector/schedule-meet",
        pageId: "student-schedule-meet",
        permissions: ["student:read"],
      },
      {
        id: "resources",
        label: "Resources",
        icon: FileText,
        path: "/student/mentor-connector/resources",
        pageId: "student-mentor-resources",
        permissions: ["student:read"],
      },
      {
        id: "logs",
        label: "Session Logs",
        icon: FileText,
        path: "/student/mentor-connector/logs",
        pageId: "student-mentor-logs",
        permissions: ["student:read"],
      },
      {
        id: "notes",
        label: "Session Notes",
        icon: MessageSquare,
        path: "/student/mentor-connector/notes",
        pageId: "student-mentor-notes",
        permissions: ["student:read"],
      },
    ],
  },
