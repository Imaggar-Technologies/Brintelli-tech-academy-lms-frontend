...
import { Lock, GraduationCap, ExternalLink } from "lucide-react";
        ...
        <div className="hidden lg:flex lg:w-1/2 items-center justify-center bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 p-12">
          ...
          >
            ...
            <div className="relative z-10 text-center p-8">
              ...
              <h3 className="mb-4 text-3xl font-bold text-slate-800">Start Learning Today</h3>
              <p className="mb-6 text-lg text-slate-700">Join our community of tech learners</p>
