...
export const ROLE_PERMISSIONS = {
  admin: [
    ...
    PERMISSIONS.PROGRAMS_CREATE, PERMISSIONS.PROGRAMS_READ, PERMISSIONS.PROGRAMS_UPDATE, PERMISSIONS.PROGRAMS_DELETE,
    PERMISSIONS.MODULES_CREATE, PERMISSIONS.MODULES_READ, PERMISSIONS.MODULES_UPDATE, PERMISSIONS.MODULES_DELETE,
    PERMISSIONS.SESSIONS_CREATE, PERMISSIONS.SESSIONS_READ, PERMISSIONS.SESSIONS_UPDATE, PERMISSIONS.SESSIONS_DELETE,
  ...
  lsm: [
    ...
    PERMISSIONS.PROGRAMS_READ, // Need to view programs for batch management
  ],
  mentor: [
    PERMISSIONS.MENTOR_READ, PERMISSIONS.MENTOR_UPDATE, PERMISSIONS.MENTOR_CREATE,
    PERMISSIONS.STUDENTS_READ,
  ...
  programManager: [
    PERMISSIONS.BATCHES_READ, PERMISSIONS.BATCHES_UPDATE, PERMISSIONS.BATCHES_CREATE, PERMISSIONS.BATCHES_DELETE,
    PERMISSIONS.COURSES_READ, PERMISSIONS.COURSES_UPDATE, PERMISSIONS.COURSES_CREATE,
    PERMISSIONS.PROGRAMS_READ, PERMISSIONS.PROGRAMS_UPDATE, PERMISSIONS.PROGRAMS_CREATE, PERMISSIONS.PROGRAMS_DELETE,
    PERMISSIONS.MODULES_READ, PERMISSIONS.MODULES_UPDATE, PERMISSIONS.MODULES_CREATE,
    PERMISSIONS.SESSIONS_READ, PERMISSIONS.SESSIONS_UPDATE, PERMISSIONS.SESSIONS_CREATE,
    PERMISSIONS.ASSIGNMENTS_READ, PERMISSIONS.ASSIGNMENTS_UPDATE, PERMISSIONS.ASSIGNMENTS_CREATE,
    PERMISSIONS.STUDENTS_READ,
    PERMISSIONS.USERS_READ, // Need to view tutors and other users for program management
  ],
  'program-manager': [
    PERMISSIONS.BATCHES_READ, PERMISSIONS.BATCHES_UPDATE, PERMISSIONS.BATCHES_CREATE, PERMISSIONS.BATCHES_DELETE,
    PERMISSIONS.COURSES_READ, PERMISSIONS.COURSES_UPDATE, PERMISSIONS.COURSES_CREATE,
