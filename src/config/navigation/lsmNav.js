...
const lsmNav = [
  ...
  },
  {
    ...
    icon: UsersRound,
    children: [
      { label: "My Mentees", icon: UsersRound, path: "/lsm/mentees", pageId: "lsm-mentees" },
      { label: "Mentee Profiles", icon: UserCog, path: "/lsm/profiles", pageId: "lsm-profiles" },
      { label: "Risk Students", icon: Target, path: "/lsm/risk-students", pageId: "lsm-risk" },
      { label: "Escalations", icon: ShieldCheck, path: "/lsm/escalations", pageId: "lsm-escalations" },
    ],
  },
  {
    id: "sessions",
